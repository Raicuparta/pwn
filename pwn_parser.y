...
vardecl :  qualifier type var				{ $$ = new pwn::var_decl_node(LINE, $3, $2); }
				| qualifier type var ';'				{ $$ = new pwn::var_decl_node(LINE, $3, $2); }
			  ;

funcdecl : qualifier func 					{ $$ = new pwn::func_def_node(LINE, $2, nullptr, nullptr, $1); }
